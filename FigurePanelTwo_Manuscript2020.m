...
ylim([-10,40])
% vessel diameter
ax34 = subplot(6,4,[10,11,12,14,15,16]);
...
ylabel('\DeltaD/D (%)')
legend([p3,x1,x2,x3],'Arteriole','Awake onset','NREM onset','REM onset')
set(gca,'Xticklabel',[])
set(gca,'box','off')
axis tight
xticks([15,75,135,195,255,315,375,435,495,555,615])
...
xlim([15,615])
% Axes properties
ax7Pos = get(ax1,'position');
ax11Pos = get(ax5,'position');
ax12Pos = get(ax6,'position');
ax11Pos(3:4) = ax7Pos(3:4);
ax12Pos(3:4) = ax7Pos(3:4);
set(ax5,'position',ax11Pos);
set(ax6,'position',ax12Pos);
%% save figure(s)
...
subplot(12,1,5); cla; subplot(12,1,6); cla; subplot(12,1,11); cla; subplot(12,1,12); cla;
