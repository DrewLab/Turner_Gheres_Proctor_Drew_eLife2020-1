function [] = ProcessIntrinsicData_IOS_eLife2020(animalID,imagingType,rawDataFileIDs,procDataFileIDs)
...
[ROIs] = CheckROIDates_IOS_eLife2020(animalID,ROIs,ROInames,imagingType);
% Extract CBV data from each ROI for each RawData file in the directory that hasn't been processed yet.
ExtractCBVData_IOS_eLife2020(ROIs,ROInames,rawDataFileIDs)
...
for a = 1:size(procDataFileIDs,1)
    ...
    CheckForNaNs_IOS_eLife2020(ProcData);
