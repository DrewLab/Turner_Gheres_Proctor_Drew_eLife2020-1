...
[animalID,~,~] = GetFileInfo_IOS_eLife2020(rawDataFileIDs(1,:));
...
ProcessRawDataFiles_IOS_eLife2020(rawDataFileIDs)
...
ProcessIntrinsicData_IOS_eLife2020(animalID,imagingType,rawDataFileIDs,procDataFileIDs)

%% BLOCK PURPOSE: [3] Add Heart Rate to the ProcData structures.
disp('Analyzing Block [3] Adding heart rate to ProcData files.'); disp(' ')
ExtractHeartRate_IOS_eLife2020(procDataFileIDs,imagingType)

%% BLOCK PURPOSE: [4] Check/Correct IOS pixel drift.
disp('Analyzing Block [4] Correcting pixel drift.'); disp(' ')
if strcmp(imagingType,'bilateral') == true
    CorrectBilateralPixelDrift_IOS_eLife2020(procDataFileIDs)
elseif strcmp(imagingType,'single') == true
    CorrectPixelDrift_IOS_eLife2020(procDataFileIDs)
end
