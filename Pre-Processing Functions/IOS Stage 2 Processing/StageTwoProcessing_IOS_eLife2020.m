...
[animalID,~,~] = GetFileInfo_IOS_Manuscript2020(rawDataFileIDs(1,:));
...
if strcmp(imagingType,'bilateral') == true
    CorrectBilateralPixelDrift_IOS_Manuscript2020(procDataFileIDs)
elseif strcmp(imagingType,'single') == true
    CorrectPixelDrift_IOS_Manuscript2020(procDataFileIDs)
end
