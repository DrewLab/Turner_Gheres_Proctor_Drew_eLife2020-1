function [SpecData] = NormalizeSpectrograms_2P_Manuscript2020(specDataFiles,neuralDataTypes,RestingBaselines)
...
for a = 1:size(specDataFiles,1)
    ...
    [~,~,fileDate,~,~,~] = GetFileInfo2_2P_Manuscript2020(specDataFiles(a,:));
