function [SleepData] = CreateSleepData_2P_Manuscript2020(NREMsleepTime,REMsleepTime,modelName,SleepData)
...
%________________________________________________________________________________________________________________________
%
%   Purpose: This function uses the sleep logicals in each MergedData file to find periods where there are a desired number
%            of consecutive sleep bins in a row and concatenate the values into a SleepData.mat structure
%________________________________________________________________________________________________________________________
