    ...
    if isempty(sleepIndex)  % If sleepIndex is empty, skip this file
        ...
        if isempty(SleepData)  % If the structure is empty, we need a special case to format the struct properly
            for cellLength = 1:size(cellLH_DeltaPower, 2)   % Loop through however many sleep epochs this file has
                SleepData.NREM.data.cortical_LH.deltaBandPower{cellLength, 1} = cellLH_DeltaPower{1, 1};
                SleepData.NREM.data.cortical_RH.deltaBandPower{cellLength, 1} = cellRH_DeltaPower{1, 1};
                SleepData.NREM.data.cortical_LH.thetaBandPower{cellLength, 1} = cellLH_ThetaPower{1, 1};
                SleepData.NREM.data.cortical_RH.thetaBandPower{cellLength, 1} = cellRH_ThetaPower{1, 1};
                SleepData.NREM.data.cortical_LH.alphaBandPower{cellLength, 1} = cellLH_AlphaPower{1, 1};
                SleepData.NREM.data.cortical_RH.alphaBandPower{cellLength, 1} = cellRH_AlphaPower{1, 1};
                SleepData.NREM.data.cortical_LH.betaBandPower{cellLength, 1} = cellLH_BetaPower{1, 1};
                ...
                SleepData.NREM.data.cortical_RH.specThetaBandPower{cellLength, 1} = cellRH_specThetaPower{1, 1};
                SleepData.NREM.data.cortical_LH.specAlphaBandPower{cellLength, 1} = cellLH_specAlphaPower{1, 1};
                SleepData.NREM.data.cortical_RH.specAlphaBandPower{cellLength, 1} = cellRH_specAlphaPower{1, 1};
                SleepData.NREM.data.cortical_LH.specBetaBandPower{cellLength, 1} = cellLH_specBetaPower{1, 1};
                SleepData.NREM.data.cortical_RH.specBetaBandPower{cellLength, 1} = cellRH_specBetaPower{1, 1};
                SleepData.NREM.data.cortical_LH.specGammaBandPower{cellLength, 1} = cellLH_specGammaPower{1, 1};
                SleepData.NREM.data.cortical_RH.specGammaBandPower{cellLength, 1} = cellRH_specGammaPower{1, 1};
                
                SleepData.NREM.data.hippocampus.specDeltaBandPower{cellLength, 1} = cellHip_specDeltaPower{1, 1};
                SleepData.NREM.data.hippocampus.specThetaBandPower{cellLength, 1} = cellHip_specThetaPower{1, 1};
                SleepData.NREM.data.hippocampus.specAlphaBandPower{cellLength, 1} = cellHip_specAlphaPower{1, 1};
                SleepData.NREM.data.hippocampus.specBetaBandPower{cellLength, 1} = cellHip_specBetaPower{1, 1};
                SleepData.NREM.data.hippocampus.specGammaBandPower{cellLength, 1} = cellHip_specGammaPower{1, 1};
            ...
            for cellLength = 1:size(cellLH_DeltaPower, 1)   % Loop through however many sleep epochs this file has
                SleepData.NREM.data.cortical_LH.deltaBandPower{size(SleepData.NREM.data.cortical_LH.deltaBandPower, 1) + 1, 1} = cellLH_DeltaPower{cellLength, 1};
                SleepData.NREM.data.cortical_RH.deltaBandPower{size(SleepData.NREM.data.cortical_RH.deltaBandPower, 1) + 1, 1} = cellRH_DeltaPower{cellLength, 1};
                SleepData.NREM.data.cortical_LH.thetaBandPower{size(SleepData.NREM.data.cortical_LH.thetaBandPower, 1) + 1, 1} = cellLH_ThetaPower{cellLength, 1};
                SleepData.NREM.data.cortical_RH.thetaBandPower{size(SleepData.NREM.data.cortical_RH.thetaBandPower, 1) + 1, 1} = cellRH_ThetaPower{cellLength, 1};
                SleepData.NREM.data.cortical_LH.alphaBandPower{size(SleepData.NREM.data.cortical_LH.alphaBandPower, 1) + 1, 1} = cellLH_AlphaPower{cellLength, 1};
                SleepData.NREM.data.cortical_RH.alphaBandPower{size(SleepData.NREM.data.cortical_RH.alphaBandPower, 1) + 1, 1} = cellRH_AlphaPower{cellLength, 1};
                SleepData.NREM.data.cortical_LH.betaBandPower{size(SleepData.NREM.data.cortical_LH.betaBandPower, 1) + 1, 1} = cellLH_BetaPower{cellLength, 1};
                ...
                SleepData.NREM.data.cortical_LH.specThetaBandPower{size(SleepData.NREM.data.cortical_LH.specThetaBandPower, 1) + 1, 1} = cellLH_specThetaPower{cellLength, 1};
                SleepData.NREM.data.cortical_RH.specThetaBandPower{size(SleepData.NREM.data.cortical_RH.specThetaBandPower, 1) + 1, 1} = cellRH_specThetaPower{cellLength, 1};
                SleepData.NREM.data.cortical_LH.specAlphaBandPower{size(SleepData.NREM.data.cortical_LH.specAlphaBandPower, 1) + 1, 1} = cellLH_specAlphaPower{cellLength, 1};
                SleepData.NREM.data.cortical_RH.specAlphaBandPower{size(SleepData.NREM.data.cortical_RH.specAlphaBandPower, 1) + 1, 1} = cellRH_specAlphaPower{cellLength, 1};
                SleepData.NREM.data.cortical_LH.specBetaBandPower{size(SleepData.NREM.data.cortical_LH.specBetaBandPower, 1) + 1, 1} = cellLH_specBetaPower{cellLength, 1};
                SleepData.NREM.data.cortical_RH.specBetaBandPower{size(SleepData.NREM.data.cortical_RH.specBetaBandPower, 1) + 1, 1} = cellRH_specBetaPower{cellLength, 1};
                SleepData.NREM.data.cortical_LH.specGammaBandPower{size(SleepData.NREM.data.cortical_LH.specGammaBandPower, 1) + 1, 1} = cellLH_specGammaPower{cellLength, 1};
                SleepData.NREM.data.cortical_RH.specGammaBandPower{size(SleepData.NREM.data.cortical_RH.specGammaBandPower, 1) + 1, 1} = cellRH_specGammaPower{cellLength, 1};

                SleepData.NREM.data.hippocampus.specDeltaBandPower{size(SleepData.NREM.data.hippocampus.specDeltaBandPower, 1) + 1, 1} = cellHip_specDeltaPower{cellLength, 1};
                SleepData.NREM.data.hippocampus.specThetaBandPower{size(SleepData.NREM.data.hippocampus.specThetaBandPower, 1) + 1, 1} = cellHip_specThetaPower{cellLength, 1};
                SleepData.NREM.data.hippocampus.specAlphaBandPower{size(SleepData.NREM.data.hippocampus.specAlphaBandPower, 1) + 1, 1} = cellHip_specAlphaPower{cellLength, 1};
                SleepData.NREM.data.hippocampus.specBetaBandPower{size(SleepData.NREM.data.hippocampus.specBetaBandPower, 1) + 1, 1} = cellHip_specBetaPower{cellLength, 1};
                SleepData.NREM.data.hippocampus.specGammaBandPower{size(SleepData.NREM.data.hippocampus.specGammaBandPower, 1) + 1, 1} = cellHip_specGammaPower{cellLength, 1};
...
for a = 1:size(procDataFileIDs, 1)           % Loop through the list of ProcData files
    ...
    if isempty(sleepIndex)  % If sleepIndex is empty, skip this file
        ...
        %% BLOCK PURPOSE: Save the data in the SleepEventData struct
        if ~isfield(SleepData, 'REM')  % If the structure is empty, we need a special case to format the struct properly
            for cellLength = 1:size(cellLH_DeltaPower, 2)   % Loop through however many sleep epochs this file has
                SleepData.REM.data.cortical_LH.deltaBandPower{cellLength, 1} = cellLH_DeltaPower{1, 1};
                SleepData.REM.data.cortical_RH.deltaBandPower{cellLength, 1} = cellRH_DeltaPower{1, 1};
                SleepData.REM.data.cortical_LH.thetaBandPower{cellLength, 1} = cellLH_ThetaPower{1, 1};
                SleepData.REM.data.cortical_RH.thetaBandPower{cellLength, 1} = cellRH_ThetaPower{1, 1};
                SleepData.REM.data.cortical_LH.alphaBandPower{cellLength, 1} = cellLH_AlphaPower{1, 1};
                SleepData.REM.data.cortical_RH.alphaBandPower{cellLength, 1} = cellRH_AlphaPower{1, 1};
                SleepData.REM.data.cortical_LH.betaBandPower{cellLength, 1} = cellLH_BetaPower{1, 1};
                ...
                SleepData.REM.data.cortical_RH.specThetaBandPower{cellLength, 1} = cellRH_specThetaPower{1, 1};
                SleepData.REM.data.cortical_LH.specAlphaBandPower{cellLength, 1} = cellLH_specAlphaPower{1, 1};
                SleepData.REM.data.cortical_RH.specAlphaBandPower{cellLength, 1} = cellRH_specAlphaPower{1, 1};
                SleepData.REM.data.cortical_LH.specBetaBandPower{cellLength, 1} = cellLH_specBetaPower{1, 1};
                SleepData.REM.data.cortical_RH.specBetaBandPower{cellLength, 1} = cellRH_specBetaPower{1, 1};
                SleepData.REM.data.cortical_LH.specGammaBandPower{cellLength, 1} = cellLH_specGammaPower{1, 1};
                SleepData.REM.data.cortical_RH.specGammaBandPower{cellLength, 1} = cellRH_specGammaPower{1, 1};
                
                SleepData.REM.data.hippocampus.specDeltaBandPower{cellLength, 1} = cellHip_specDeltaPower{1, 1};
                SleepData.REM.data.hippocampus.specThetaBandPower{cellLength, 1} = cellHip_specThetaPower{1, 1};
                SleepData.REM.data.hippocampus.specAlphaBandPower{cellLength, 1} = cellHip_specAlphaPower{1, 1};
                SleepData.REM.data.hippocampus.specBetaBandPower{cellLength, 1} = cellHip_specBetaPower{1, 1};
                SleepData.REM.data.hippocampus.specGammaBandPower{cellLength, 1} = cellHip_specGammaPower{1, 1};
            ...
            for cellLength = 1:size(cellLH_DeltaPower, 1)   % Loop through however many sleep epochs this file has
                SleepData.REM.data.cortical_LH.deltaBandPower{size(SleepData.REM.data.cortical_LH.deltaBandPower, 1) + 1, 1} = cellLH_DeltaPower{cellLength, 1};
                SleepData.REM.data.cortical_RH.deltaBandPower{size(SleepData.REM.data.cortical_RH.deltaBandPower, 1) + 1, 1} = cellRH_DeltaPower{cellLength, 1};
                SleepData.REM.data.cortical_LH.thetaBandPower{size(SleepData.REM.data.cortical_LH.thetaBandPower, 1) + 1, 1} = cellLH_ThetaPower{cellLength, 1};
                SleepData.REM.data.cortical_RH.thetaBandPower{size(SleepData.REM.data.cortical_RH.thetaBandPower, 1) + 1, 1} = cellRH_ThetaPower{cellLength, 1};
                SleepData.REM.data.cortical_LH.alphaBandPower{size(SleepData.REM.data.cortical_LH.alphaBandPower, 1) + 1, 1} = cellLH_AlphaPower{cellLength, 1};
                SleepData.REM.data.cortical_RH.alphaBandPower{size(SleepData.REM.data.cortical_RH.alphaBandPower, 1) + 1, 1} = cellRH_AlphaPower{cellLength, 1};
                SleepData.REM.data.cortical_LH.betaBandPower{size(SleepData.REM.data.cortical_LH.betaBandPower, 1) + 1, 1} = cellLH_BetaPower{cellLength, 1};
                ...
                SleepData.REM.data.cortical_LH.specThetaBandPower{size(SleepData.REM.data.cortical_LH.specThetaBandPower, 1) + 1, 1} = cellLH_specThetaPower{cellLength, 1};
                SleepData.REM.data.cortical_RH.specThetaBandPower{size(SleepData.REM.data.cortical_RH.specThetaBandPower, 1) + 1, 1} = cellRH_specThetaPower{cellLength, 1};
                SleepData.REM.data.cortical_LH.specAlphaBandPower{size(SleepData.REM.data.cortical_LH.specAlphaBandPower, 1) + 1, 1} = cellLH_specAlphaPower{cellLength, 1};
                SleepData.REM.data.cortical_RH.specAlphaBandPower{size(SleepData.REM.data.cortical_RH.specAlphaBandPower, 1) + 1, 1} = cellRH_specAlphaPower{cellLength, 1};
                SleepData.REM.data.cortical_LH.specBetaBandPower{size(SleepData.REM.data.cortical_LH.specBetaBandPower, 1) + 1, 1} = cellLH_specBetaPower{cellLength, 1};
                SleepData.REM.data.cortical_RH.specBetaBandPower{size(SleepData.REM.data.cortical_RH.specBetaBandPower, 1) + 1, 1} = cellRH_specBetaPower{cellLength, 1};
                SleepData.REM.data.cortical_LH.specGammaBandPower{size(SleepData.REM.data.cortical_LH.specGammaBandPower, 1) + 1, 1} = cellLH_specGammaPower{cellLength, 1};
                SleepData.REM.data.cortical_RH.specGammaBandPower{size(SleepData.REM.data.cortical_RH.specGammaBandPower, 1) + 1, 1} = cellRH_specGammaPower{cellLength, 1};

                SleepData.REM.data.hippocampus.specDeltaBandPower{size(SleepData.REM.data.hippocampus.specDeltaBandPower, 1) + 1, 1} = cellHip_specDeltaPower{cellLength, 1};
                SleepData.REM.data.hippocampus.specThetaBandPower{size(SleepData.REM.data.hippocampus.specThetaBandPower, 1) + 1, 1} = cellHip_specThetaPower{cellLength, 1};
                SleepData.REM.data.hippocampus.specAlphaBandPower{size(SleepData.REM.data.hippocampus.specAlphaBandPower, 1) + 1, 1} = cellHip_specAlphaPower{cellLength, 1};
                SleepData.REM.data.hippocampus.specBetaBandPower{size(SleepData.REM.data.hippocampus.specBetaBandPower, 1) + 1, 1} = cellHip_specBetaPower{cellLength, 1};
                SleepData.REM.data.hippocampus.specGammaBandPower{size(SleepData.REM.data.hippocampus.specGammaBandPower, 1) + 1, 1} = cellHip_specGammaPower{cellLength, 1};
