function [angle] = WhiskerTrackerParallel_IOS_Manuscript2020(fileName)
...
importStart = tic;
baslerFrames = ReadBinFileU8MatrixGradient_IOS_Manuscript2020([fileName '_WhiskerCam.bin'],350,30);
