function [SpecData] = NormalizeSpectrograms_2P(specDataFiles, RestingBaselines,neuralDataTypes)
...
for a = 1:size(specDataFiles,1)
    ...
    [animalID,hem,fileDate,fileID,imageID,vesselID] = GetFileInfo2_2P(specDataFiles(a,:));
