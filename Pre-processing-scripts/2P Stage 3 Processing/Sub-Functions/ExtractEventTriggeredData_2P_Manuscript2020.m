function [EventData] = ExtractEventTriggeredData_2P_Manuscript2020(mergedDataFileIDs,dataTypes)
...
for dT = 1:length(dataTypes)
    ...
    [EventData] = ProcessTempStruct_2P_Manuscript2020(EventData,dataType,temp,epoch);
end
save([animalID '_EventData.mat'],'EventData');

end

function [chunkData,evFilter] = ExtractBehavioralData_2P_Manuscript2020(data,epoch,dataType,samplingRate,behavior)
% Setup variables
...
function [EventData] = ProcessTempStruct_2P_Manuscript2020(EventData,dataType,temp,epoch)
