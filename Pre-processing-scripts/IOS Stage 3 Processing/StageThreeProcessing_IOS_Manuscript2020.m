...
for bb = 1:size(procDataFileIDs,1)
    ...
    [figHandle] = GenerateSingleFigures_IOS_Manuscript2020(procDataFileID,RestingBaselines,updatedBaselineType,saveFigs,imagingType,hemoType);
    close(figHandle)
end
% HbT
hemoType = 'HbT';
...
% SetIsofluraneHbT_IOS_Manuscript2020()
