function [AnalysisResults] = Fig1_S6_eLife2020(rootFolder,saveFigs,delim,AnalysisResults)
...
%________________________________________________________________________________________________________________________
%
% Purpose: Generate figure panel 1_S6 for Turner_Gheres_Proctor_Drew_eLife2020
%________________________________________________________________________________________________________________________
...
%% Fig. 1_S6
summaryFigure = figure('Name','Fig1_S6 (a-f)');
sgtitle('Figure 1_S6 - Turner et al. 2020')
...
if strcmp(saveFigs,'y') == true
    ...
    savefig(summaryFigure,[dirpath 'Fig1_S6']);
    ...
    print('-painters','-dpdf','-bestfit',[dirpath 'Fig1_S6'])
    close(summaryFigure)
    %% subplot figures
    ...
    axis off
    xlim([0,600])
    print('-painters','-dtiffn',[dirpath 'Fig1_S6_SpecImages'])
    close(summaryFigure_imgs)
    %% Fig. 1_S6
    figure('Name','Fig1_S6 (a-f)');
    sgtitle('Figure 1_S6 - Turner et al. 2020')
    %% EMG and force sensor
    ax1 = subplot(7,1,1);
    p1 = plot((1:length(filtEMG))/dsFs,filtEMG,'color',colors_eLife2020('rich black'),'LineWidth',0.5);
