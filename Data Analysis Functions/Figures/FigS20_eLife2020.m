function [AnalysisResults] = FigS20_Manuscript2020(rootFolder,saveFigs,delim,AnalysisResults)
%________________________________________________________________________________________________________________________
% Written by Kevin L. Turner
% The Pennsylvania State University, Dept. of Biomedical Engineering
% https://github.com/KL-Turner
%
% Purpose: Generate figure panel S20 for Turner_Gheres_Proctor_Drew_Manuscript2020
%________________________________________________________________________________________________________________________
...
%% Fig. S20
summaryFigure = figure('Name','FigS20 (a-p');
sgtitle('Figure S20 - Turner et al. 2020')
%% [S20a] delta PSD @ 0.1 Hz
ax1 = subplot(4,4,1);
...
e6.MarkerSize = 10;
e6.CapSize = 10;
title({'[S20a] PSD @ 0.1 Hz','Delta-band [1-4 Hz]'})
ylabel('Power (a.u.)')
...
e3.MarkerSize = 10;
e3.CapSize = 10;
title({'[S20b] PSD @ 0.01 Hz','Delta-band [1-4 Hz]'})
ylabel('Power (a.u.)')
set(gca,'xtick',[])
set(gca,'xticklabel',[])
set(gca,'yscale','log')
...
e6.MarkerSize = 10;
e6.CapSize = 10;
title({'[S20c] Coherence^2 @ 0.1 Hz','Delta-band [1-4 Hz]'})
ylabel('Coherence^2')
set(gca,'xtick',[])
set(gca,'xticklabel',[])
axis square
...
%% [S20d] delta coherence^2 @ 0.01 Hz
ax4 = subplot(4,4,4);
...
e3.MarkerSize = 10;
e3.CapSize = 10;
title({'[S20d] Coherence^2 @ 0.01 Hz','Delta-band [1-4 Hz]'})
ylabel('Coherence^2')
set(gca,'xtick',[])
set(gca,'xticklabel',[])
axis square
...
e6.MarkerSize = 10;
e6.CapSize = 10;
title({'[S20e] PSD @ 0.1 Hz','Theta-band [4-10 Hz]'})
ylabel('Power (a.u.)')
set(gca,'xtick',[])
set(gca,'xticklabel',[])
set(gca,'yscale','log')
...
e3.MarkerSize = 10;
e3.CapSize = 10;
title({'[S20f] PSD @ 0.01 Hz','Theta-band [4-10 Hz]'})
ylabel('Power (a.u.)')
set(gca,'xtick',[])
set(gca,'xticklabel',[])
set(gca,'yscale','log')
...
e6.MarkerSize = 10;
e6.CapSize = 10;
title({'[S20g] Coherence^2 @ 0.1 Hz','Theta-band [4-10 Hz]'})
ylabel('Coherence^2')
set(gca,'xtick',[])
set(gca,'xticklabel',[])
axis square
...
%% [S20h] theta coherence^2 @ 0.01 Hz
ax8 = subplot(4,4,8);
...
e3.MarkerSize = 10;
e3.CapSize = 10;
title({'[S20h] Coherence^2 @ 0.01 Hz','Theta-band [4-10 Hz]'})
ylabel('Coherence^2')
set(gca,'xtick',[])
set(gca,'xticklabel',[])
axis square
...
e6.MarkerSize = 10;
e6.CapSize = 10;
title({'[S20i] PSD @ 0.1 Hz','Alpha-band [10-13 Hz]'})
ylabel('Power (a.u.)')
set(gca,'xtick',[])
set(gca,'xticklabel',[])
set(gca,'yscale','log')
...
e3.MarkerSize = 10;
e3.CapSize = 10;
title({'[S20j] PSD @ 0.01 Hz','Alpha-band [10-13 Hz]'})
ylabel('Power (a.u.)')
set(gca,'xtick',[])
set(gca,'xticklabel',[])
set(gca,'yscale','log')
...
e6.MarkerSize = 10;
e6.CapSize = 10;
title({'[S20k] Coherence^2 @ 0.1 Hz','Alpha-band [10-13 Hz]'})
ylabel('Coherence^2')
set(gca,'xtick',[])
set(gca,'xticklabel',[])
axis square
...
%% [S20l] alpha coherence^2 @ 0.01 Hz
ax12 = subplot(4,4,12);
...
e3.MarkerSize = 10;
e3.CapSize = 10;
title({'[S20l] Coherence^2 @ 0.01 Hz','Alpha-band [10-13 Hz]'})
ylabel('Coherence^2')
set(gca,'xtick',[])
set(gca,'xticklabel',[])
axis square
...
e6.MarkerSize = 10;
e6.CapSize = 10;
title({'[S20m] PSD @ 0.1 Hz','Beta-band [13-30 Hz]'})
ylabel('Power (a.u.)')
set(gca,'xtick',[])
set(gca,'xticklabel',[])
set(gca,'yscale','log')
...
e3.MarkerSize = 10;
e3.CapSize = 10;
title({'[S20n] PSD @ 0.01 Hz','Beta-band [13-30 Hz]'})
ylabel('Power (a.u.)')
set(gca,'xtick',[])
set(gca,'xticklabel',[])
set(gca,'yscale','log')
...
e6.MarkerSize = 10;
e6.CapSize = 10;
title({'[S20o] Coherence^2 @ 0.1 Hz','Beta-band [13-30 Hz]'})
ylabel('Coherence^2')
set(gca,'xtick',[])
set(gca,'xticklabel',[])
axis square
...
e3.MarkerSize = 10;
e3.CapSize = 10;
title({'[S20p] Coherence^2 @ 0.01 Hz','Beta-band [13-30 Hz]'})
ylabel('Coherence^2')
set(gca,'xtick',[])
set(gca,'xticklabel',[])
axis square
...
if strcmp(saveFigs,'y') == true
    ...
    disp('======================================================================================================================')
    disp('[S20a] Generalized linear mixed-effects model statistics for delta-band PSD @ 0.1 Hz for Rest, NREM, REM, Awake, Sleep, and All')
    disp('======================================================================================================================')
    ...
    disp('======================================================================================================================')
    disp('[S20b] Generalized linear mixed-effects model statistics for delta-band PSD @ 0.01 Hz for Awake, Sleep, and All')
    disp('======================================================================================================================')
    ...
    disp('======================================================================================================================')
    disp('[S20c] Generalized linear mixed-effects model statistics for delta-band coherence^2 @ 0.1 Hz for Rest, NREM, REM, Awake, Sleep, and All')
    disp('======================================================================================================================')
    ...
    disp('======================================================================================================================')
    disp('[S20d] Generalized linear mixed-effects model statistics for delta-band coherence^2 @ 0.01 Hz for Awake, Sleep, and All')
    disp('======================================================================================================================')
    ...
    disp('======================================================================================================================')
    disp('[S20e] Generalized linear mixed-effects model statistics for theta-band PSD @ 0.1 Hz for Rest, NREM, REM, Awake, Sleep, and All')
    disp('======================================================================================================================')
    ...
    disp('======================================================================================================================')
    disp('[S20f] Generalized linear mixed-effects model statistics for theta-band PSD @ 0.01 Hz for Awake, Sleep, and All')
    disp('======================================================================================================================')
    ...
    disp('======================================================================================================================')
    disp('[S20g] Generalized linear mixed-effects model statistics for theta-band coherence^2 @ 0.1 Hz for Rest, NREM, REM, Awake, Sleep, and All')
    disp('======================================================================================================================')
    ...
    disp('======================================================================================================================')
    disp('[S20h] Generalized linear mixed-effects model statistics for theta-band coherence^2 @ 0.01 Hz for Awake, Sleep, and All')
    disp('======================================================================================================================')
    ...
    disp('======================================================================================================================')
    disp('[S20i] Generalized linear mixed-effects model statistics for alpha-band PSD @ 0.1 Hz for Rest, NREM, REM, Awake, Sleep, and All')
    disp('======================================================================================================================')
    ...
    disp('======================================================================================================================')
    disp('[S20j] Generalized linear mixed-effects model statistics for alpha-band PSD @ 0.01 Hz for Awake, Sleep, and All')
    disp('======================================================================================================================')
    ...
    disp('======================================================================================================================')
    disp('[S20k] Generalized linear mixed-effects model statistics for alpha-band coherence^2 @ 0.1 Hz for Rest, NREM, REM, Awake, Sleep, and All')
    disp('======================================================================================================================')
    ...
    disp('======================================================================================================================')
    disp('[S20l] Generalized linear mixed-effects model statistics for alpha-band coherence^2 @ 0.01 Hz for Awake, Sleep, and All')
    disp('======================================================================================================================')
    ...
    disp('======================================================================================================================')
    disp('[S20m] Generalized linear mixed-effects model statistics for beta-band PSD @ 0.1 Hz for Rest, NREM, REM, Awake, Sleep, and All')
    disp('======================================================================================================================')
    ...
    disp('======================================================================================================================')
    disp('[S20n] Generalized linear mixed-effects model statistics for beta-band PSD @ 0.01 Hz for Awake, Sleep, and All')
    disp('======================================================================================================================')
    ...
    disp('======================================================================================================================')
    disp('[S20o] Generalized linear mixed-effects model statistics for beta-band coherence^2 @ 0.1 Hz for Rest, NREM, REM, Awake, Sleep, and All')
    disp('======================================================================================================================')
    ...
    disp('======================================================================================================================')
    disp('[S20p] Generalized linear mixed-effects model statistics for beta-band coherence^2 @ 0.01 Hz for Awake, Sleep, and All')
    disp('======================================================================================================================')
