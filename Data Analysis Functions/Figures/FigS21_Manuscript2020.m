function [AnalysisResults] = FigS21_Manuscript2020(rootFolder,saveFigs,delim,AnalysisResults)
...
%% Fig. S21
summaryFigure = figure('Name','FigS21 (a-o)');
sgtitle('Figure S21 - Turner et al. 2020')
%% [S21a] coherence between delta-band power and HbT during different arousal-states
ax1 = subplot(5,3,1);
...
ylabel('Coherence^2')
xlabel('Freq (Hz)')
title({'[S21a] Neural-hemo coherence^2','Delta-[HbT]'})
...
%% [S21b] coherence between delta-band power and HbT during different arousal-states @ 0.1 Hz
ax2 = subplot(5,3,2);
...
e6.MarkerSize = 10;
e6.CapSize = 10;
title({'[S21b] Coherence^2 @ 0.1 Hz','Delta-[HbT]'})
ylabel('Coherence^2')
set(gca,'xtick',[])
set(gca,'xticklabel',[])
axis square
...
%% [S21c] coherence between delta-band power and HbT during different arousal-states @ 0.01 Hz
ax3 = subplot(5,3,3);
...
e3.MarkerSize = 10;
e3.CapSize = 10;
title({'[S21c] Coherence^2 @ 0.01 Hz','Delta-[HbT]'})
ylabel('Coherence^2')
set(gca,'xtick',[])
set(gca,'xticklabel',[])
axis square
...
%% [S21d] coherence between theta-band power and HbT during different arousal-states
ax4 = subplot(5,3,4);
...
ylabel('Coherence^2')
xlabel('Freq (Hz)')
title({'[S21d] Neural-hemo coherence^2','Theta-[HbT]'})
axis square
xlim([0.003,0.5])
ylim([0,1])
set(gca,'box','off')
ax4.TickLength = [0.03,0.03];
%% [S21e] coherence between theta-band power and HbT during different arousal-states @ 0.1 Hz
ax5 = subplot(5,3,5);
...
e6.MarkerSize = 10;
e6.CapSize = 10;
title({'[S21e] Coherence^2 @ 0.1 Hz','Theta-[HbT]'})
ylabel('Coherence^2')
set(gca,'xtick',[])
set(gca,'xticklabel',[])
axis square
...
%% [S21f] coherence between theta-band power and HbT during different arousal-states @ 0.01 Hz
ax6 = subplot(5,3,6);
...
e3.MarkerSize = 10;
e3.CapSize = 10;
title({'[S21f] Coherence^2 @ 0.01 Hz','Theta-[HbT]'})
ylabel('Coherence^2')
set(gca,'xtick',[])
set(gca,'xticklabel',[])
axis square
...
%% [S21g] coherence between alpha-band power and HbT during different arousal-states
ax7 = subplot(5,3,7);
...
ylabel('Coherence^2')
xlabel('Freq (Hz)')
title({'[S21g] Neural-hemo coherence^2','Alpha-[HbT]'})
axis square
xlim([0.003,0.5])
ylim([0,1])
set(gca,'box','off')
ax7.TickLength = [0.03,0.03];
%% [S21h] coherence between alpha-band power and HbT during different arousal-states @ 0.1 Hz
ax8 = subplot(5,3,8);
...
e6.MarkerSize = 10;
e6.CapSize = 10;
title({'[S21h] Coherence^2 @ 0.1 Hz','Alpha-[HbT]'})
ylabel('Coherence^2')
set(gca,'xtick',[])
set(gca,'xticklabel',[])
axis square
...
%% [S21i] coherence between alpha-band power and HbT during different arousal-states @ 0.01 Hz
ax9 = subplot(5,3,9);
...
e3.MarkerSize = 10;
e3.CapSize = 10;
title({'[S21i] Coherence^2 @ 0.01 Hz','Alpha-[HbT]'})
ylabel('Coherence^2')
set(gca,'xtick',[])
set(gca,'xticklabel',[])
axis square
...
%% [S21j] coherence between beta-band power and HbT during different arousal-states
ax10 = subplot(5,3,10);
...
ylabel('Coherence^2')
xlabel('Freq (Hz)')
title({'[S21j] Neural-hemo coherence^2','Beta-[HbT]'})
axis square
xlim([0.003,0.5])
ylim([0,1])
set(gca,'box','off')
ax10.TickLength = [0.03,0.03];
%% [S21k] coherence between beta-band power and HbT during different arousal-states @ 0.1 Hz
ax11 = subplot(5,3,11);
...
e6.MarkerSize = 10;
e6.CapSize = 10;
title({'[S21k] Coherence^2 @ 0.1 Hz','Beta-[HbT]'})
ylabel('Coherence^2')
set(gca,'xtick',[])
set(gca,'xticklabel',[])
axis square
...
%% [S21l] coherence between beta-band power and HbT during different arousal-states @ 0.01 Hz
ax12 = subplot(5,3,12);
...
e3.MarkerSize = 10;
e3.CapSize = 10;
title({'[S21l] Coherence^2 @ 0.01 Hz','Beta-[HbT]'})
ylabel('Coherence^2')
set(gca,'xtick',[])
set(gca,'xticklabel',[])
axis square
...
%% [S21m] coherence between gamma-band power and HbT during different arousal-states
ax13 = subplot(5,3,13);
...
ylabel('Coherence^2')
xlabel('Freq (Hz)')
title({'[S21m] Neural-hemo coherence^2','Gamma-[HbT]'})
axis square
xlim([0.003,0.5])
ylim([0,1])
set(gca,'box','off')
ax13.TickLength = [0.03,0.03];
%% [S21n] coherence between gamma-band power and HbT during different arousal-states @ 0.1 Hz
ax14 = subplot(5,3,14);
...
e6.MarkerSize = 10;
e6.CapSize = 10;
title({'[S21n] Coherence^2 @ 0.1 Hz','Gamma-[HbT]'})
ylabel('Coherence^2')
set(gca,'xtick',[])
set(gca,'xticklabel',[])
axis square
...
%% [S21o] coherence between gamma-band power and HbT during different arousal-states @ 0.01 Hz
ax15 = subplot(5,3,15);
...
e3.MarkerSize = 10;
e3.CapSize = 10;
title({'[S21o] Coherence^2 @ 0.01 Hz','Gamma-[HbT]'})
ylabel('Coherence^2')
set(gca,'xtick',[])
set(gca,'xticklabel',[])
axis square
...
if strcmp(saveFigs,'y') == true
    ...
    print('-painters','-dpdf','-fillpage',[dirpath 'FigS21'])
    %% statistical diary
    diaryFile = [dirpath 'FigS21_Statistics.txt'];
    ...
    disp('======================================================================================================================')
    disp('[S21b] Generalized linear mixed-effects model statistics for delta-HbT coherence^2 @ 0.1 Hz for Rest, NREM, REM, Awake, Sleep, and All')
    disp('======================================================================================================================')
    ...
    disp('======================================================================================================================')
    disp('[S21c] Generalized linear mixed-effects model statistics for delta-HbT coherence^2 @ 0.01 Hz for Awake, Sleep, and All')
    disp('======================================================================================================================')
    ...
    disp('======================================================================================================================')
    disp('[S21e] Generalized linear mixed-effects model statistics for Theta-[HbT] coherence^2 @ 0.1 Hz for Rest, NREM, REM, Awake, Sleep, and All')
    disp('======================================================================================================================')
    ...
    disp('======================================================================================================================')
    disp('[S21f] Generalized linear mixed-effects model statistics for Theta-[HbT] coherence^2 @ 0.01 Hz for Awake, Sleep, and All')
    disp('======================================================================================================================')
    ...
    disp('======================================================================================================================')
    disp('[S21h] Generalized linear mixed-effects model statistics for Alpha-[HbT] coherence^2 @ 0.1 Hz for Rest, NREM, REM, Awake, Sleep, and All')
    disp('======================================================================================================================')
    ...
    disp('======================================================================================================================')
    disp('[S21i] Generalized linear mixed-effects model statistics for Alpha-[HbT] coherence^2 @ 0.01 Hz for Awake, Sleep, and All')
    disp('======================================================================================================================')
    ...
    disp('======================================================================================================================')
    disp('[S21k] Generalized linear mixed-effects model statistics for Beta-[HbT] coherence^2 @ 0.1 Hz for Rest, NREM, REM, Awake, Sleep, and All')
    disp('======================================================================================================================')
    ...
    disp('======================================================================================================================')
    disp('[S21l] Generalized linear mixed-effects model statistics for Beta-[HbT] coherence^2 @ 0.01 Hz for Awake, Sleep, and All')
    disp('======================================================================================================================')
    ...
    disp('======================================================================================================================')
    disp('[S21n] Generalized linear mixed-effects model statistics for Gamma-[HbT] coherence^2 @ 0.1 Hz for Rest, NREM, REM, Awake, Sleep, and All')
    disp('======================================================================================================================')
    ...
    disp('======================================================================================================================')
    disp('[S21o] Generalized linear mixed-effects model statistics for Gamma-[HbT] coherence^2 @ 0.01 Hz for Awake, Sleep, and All')
    disp('======================================================================================================================')
