function [AnalysisResults] = FigS12_Manuscript2020(rootFolder,saveFigs,delim,AnalysisResults)
...
%________________________________________________________________________________________________________________________
%
% Purpose: Generate figure panel S12 for Turner_Gheres_Proctor_Drew_Manuscript2020
%________________________________________________________________________________________________________________________
...
if strcmp(saveFigs,'y') == true
    ...
    axis off
    xlim([0,600])
    print('-painters','-dtiffn',[dirpath 'FigS12_SpecImages'])
