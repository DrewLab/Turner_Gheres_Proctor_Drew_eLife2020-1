...
[AnalysisResults] = FigS23_eLife2020(rootFolder,saveFigs,delim,AnalysisResults);
[AnalysisResults] = FigS22_eLife2020(rootFolder,saveFigs,delim,AnalysisResults);
[AnalysisResults] = FigS21_eLife2020(rootFolder,saveFigs,delim,AnalysisResults);
[AnalysisResults] = FigS20_eLife2020(rootFolder,saveFigs,delim,AnalysisResults);
[AnalysisResults] = FigS19_eLife2020(rootFolder,saveFigs,delim,AnalysisResults);
[AnalysisResults] = FigS18_eLife2020(rootFolder,saveFigs,delim,AnalysisResults);
[AnalysisResults] = FigS17_eLife2020(rootFolder,saveFigs,delim,AnalysisResults);
[AnalysisResults] = FigS16_eLife2020(rootFolder,saveFigs,delim,AnalysisResults);
[AnalysisResults] = FigS15_eLife2020(rootFolder,saveFigs,delim,AnalysisResults);
[AnalysisResults] = FigS14_eLife2020(rootFolder,saveFigs,delim,AnalysisResults);
[AnalysisResults] = FigS13_eLife2020(rootFolder,saveFigs,delim,AnalysisResults);
[AnalysisResults] = FigS12_eLife2020(rootFolder,saveFigs,delim,AnalysisResults);
[AnalysisResults] = FigS11_eLife2020(rootFolder,saveFigs,delim,AnalysisResults);
[AnalysisResults] = FigS10_eLife2020(rootFolder,saveFigs,delim,AnalysisResults);
[AnalysisResults] = FigS9_eLife2020(rootFolder,saveFigs,delim,AnalysisResults);
[AnalysisResults] = FigS8_eLife2020(rootFolder,saveFigs,delim,AnalysisResults);
[AnalysisResults] = FigS7_eLife2020(rootFolder,saveFigs,delim,AnalysisResults);
[AnalysisResults] = FigS6_eLife2020(rootFolder,saveFigs,delim,AnalysisResults);
[AnalysisResults] = FigS5_eLife2020(rootFolder,saveFigs,delim,AnalysisResults);
[AnalysisResults] = FigS4_eLife2020(rootFolder,saveFigs,delim,AnalysisResults);
[AnalysisResults] = FigS3_eLife2020(rootFolder,saveFigs,delim,AnalysisResults);
[AnalysisResults] = FigS2_eLife2020(rootFolder,saveFigs,delim,AnalysisResults);
[AnalysisResults] = FigS1_eLife2020(rootFolder,saveFigs,delim,AnalysisResults);
%% supplemental tables
