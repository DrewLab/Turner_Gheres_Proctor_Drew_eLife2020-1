...
%% summary figure(s)
gammaSummaryFigure = figure;
sgtitle({'Gamma-band [30-100 Hz] derived HRF kernels','Mean and median R^2 Predictions'})
xInds = ones(1,length(animalIDs)*2);
% Gamma-band-derived IR analytic
subplot(2,2,1)
...
set(gca,'box','off')
xlim([0,5])
% Gamma-band-derived gamma function
subplot(2,2,2)
...
set(gca,'box','off')
xlim([0,5])
% Gamma-band-derived median R2 values
subplot(2,2,3);
scatter(xInds*1,data.gammaBandPower.Contra.Comb.medR2,100,'MarkerEdgeColor','k','MarkerFaceColor',colorE,'jitter','on','jitterAmount',0.25)
hold on
...
e1.MarkerSize = 15;
e1.CapSize = 15;
scatter(xInds*2,data.gammaBandPower.Whisk.Comb.medR2,100,'MarkerEdgeColor','k','MarkerFaceColor',colorD,'jitter','on','jitterAmount',0.25)
...
e2.MarkerSize = 15;
e2.CapSize = 15;
scatter(xInds*3,data.gammaBandPower.Rest.Comb.medR2,100,'MarkerEdgeColor','k','MarkerFaceColor',colorA,'jitter','on','jitterAmount',0.25)
e3 = errorbar(3,data.gammaBandPower.Rest.avgMedR2,data.gammaBandPower.Rest.stdMedR2,'d','MarkerEdgeColor','k','MarkerFaceColor','k');
e3.Color = 'black';
e3.MarkerSize = 15;
e3.CapSize = 15;
scatter(xInds*4,data.gammaBandPower.NREM.Comb.medR2,100,'MarkerEdgeColor','k','MarkerFaceColor',colorB,'jitter','on','jitterAmount',0.25)
e4 = errorbar(4,data.gammaBandPower.NREM.avgMedR2,data.gammaBandPower.NREM.stdMedR2,'d','MarkerEdgeColor','k','MarkerFaceColor','k');
e4.Color = 'black';
e4.MarkerSize = 15;
e4.CapSize = 15;
scatter(xInds*5,data.gammaBandPower.REM.Comb.medR2,100,'MarkerEdgeColor','k','MarkerFaceColor',colorC,'jitter','on','jitterAmount',0.25)
e5 = errorbar(5,data.gammaBandPower.REM.avgMedR2,data.gammaBandPower.REM.stdMedR2,'d','MarkerEdgeColor','k','MarkerFaceColor','k');
e5.Color = 'black';
e5.MarkerSize = 15;
e5.CapSize = 15;
title({'Gamma-band [30-100 Hz] derived';'Median R^2 gamma function kernel predictions'})
ylabel('R^2')
set(gca,'xtick',[])
set(gca,'xticklabel',[])
xlim([0,length(behavFields) + 1])
set(gca,'box','off')
% Gamma-band-derived mean R2 values
subplot(2,2,4);
scatter(xInds*1,data.gammaBandPower.Contra.Comb.meanR2,100,'MarkerEdgeColor','k','MarkerFaceColor',colorE,'jitter','on','jitterAmount',0.25)
hold on
...
e1.MarkerSize = 15;
e1.CapSize = 15;
scatter(xInds*2,data.gammaBandPower.Whisk.Comb.meanR2,100,'MarkerEdgeColor','k','MarkerFaceColor',colorD,'jitter','on','jitterAmount',0.25)
...
e2.MarkerSize = 15;
e2.CapSize = 15;
scatter(xInds*3,data.gammaBandPower.Rest.Comb.meanR2,100,'MarkerEdgeColor','k','MarkerFaceColor',colorA,'jitter','on','jitterAmount',0.25)
...
e3.MarkerSize = 15;
e3.CapSize = 15;
scatter(xInds*4,data.gammaBandPower.NREM.Comb.meanR2,100,'MarkerEdgeColor','k','MarkerFaceColor',colorB,'jitter','on','jitterAmount',0.25)
...
e4.MarkerSize = 15;
e4.CapSize = 15;
scatter(xInds*5,data.gammaBandPower.REM.Comb.meanR2,100,'MarkerEdgeColor','k','MarkerFaceColor',colorC,'jitter','on','jitterAmount',0.25)
e5 = errorbar(5,data.gammaBandPower.REM.avgMeanR2,data.gammaBandPower.REM.stdMeanR2,'d','MarkerEdgeColor','k','MarkerFaceColor','k');
e5.Color = 'black';
e5.MarkerSize = 15;
e5.CapSize = 15;
title({'Gamma-band [30-100 Hz] derived';'Mean R^2 gamma function kernel predictions'})
ylabel('R^2')
set(gca,'xtick',[])
set(gca,'xticklabel',[])
xlim([0,length(behavFields) + 1])
...
%% summary figure(s)
muaSummaryFigure = figure;
sgtitle({'Multi-unit activity [300-3000 Hz] derived HRF kernels','Mean and median R^2 Predictions'})
xInds = ones(1,length(animalIDs)*2);
% MUA-derived IR analytic
subplot(2,2,1)
...
title('Impulse response function')
xlabel('HRF Time (s)')
ylabel({'MUA [300-3000 Hz] derived';'HRF amplitude (A.U.)'})
legend([p1,p2,p3,p4,p5],'Sensory-evoked','Whisk-evoked','Rest','NREM','REM','Location','NorthEast')
set(gca,'box','off')
xlim([0,5])
% MUA-derived gamma function
subplot(2,2,2)
...
% Gamma-band-derived median R2 values
subplot(2,2,3);
scatter(xInds*1,data.muaPower.Contra.Comb.medR2,100,'MarkerEdgeColor','k','MarkerFaceColor',colorE,'jitter','on','jitterAmount',0.25)
hold on
e1 = errorbar(1,data.muaPower.Contra.avgMedR2,data.muaPower.Contra.stdMedR2,'d','MarkerEdgeColor','k','MarkerFaceColor','k');
e1.Color = 'black';
e1.MarkerSize = 15;
e1.CapSize = 15;
scatter(xInds*2,data.muaPower.Whisk.Comb.medR2,100,'MarkerEdgeColor','k','MarkerFaceColor',colorD,'jitter','on','jitterAmount',0.25)
e2 = errorbar(2,data.muaPower.Whisk.avgMedR2,data.muaPower.Whisk.stdMedR2,'d','MarkerEdgeColor','k','MarkerFaceColor','k');
e2.Color = 'black';
e2.MarkerSize = 15;
e2.CapSize = 15;
scatter(xInds*3,data.muaPower.Rest.Comb.medR2,100,'MarkerEdgeColor','k','MarkerFaceColor',colorA,'jitter','on','jitterAmount',0.25)
e3 = errorbar(3,data.muaPower.Rest.avgMedR2,data.muaPower.Rest.stdMedR2,'d','MarkerEdgeColor','k','MarkerFaceColor','k');
e3.Color = 'black';
e3.MarkerSize = 15;
e3.CapSize = 15;
scatter(xInds*4,data.muaPower.NREM.Comb.medR2,100,'MarkerEdgeColor','k','MarkerFaceColor',colorB,'jitter','on','jitterAmount',0.25)
e4 = errorbar(4,data.muaPower.NREM.avgMedR2,data.muaPower.NREM.stdMedR2,'d','MarkerEdgeColor','k','MarkerFaceColor','k');
e4.Color = 'black';
e4.MarkerSize = 15;
e4.CapSize = 15;
scatter(xInds*5,data.muaPower.REM.Comb.medR2,100,'MarkerEdgeColor','k','MarkerFaceColor',colorC,'jitter','on','jitterAmount',0.25)
e5 = errorbar(5,data.muaPower.REM.avgMedR2,data.muaPower.REM.stdMedR2,'d','MarkerEdgeColor','k','MarkerFaceColor','k');
e5.Color = 'black';
e5.MarkerSize = 15;
e5.CapSize = 15;
title({'MUA [300-3000 Hz] derived';'Median R^2 gamma function kernel predictions'})
ylabel('R^2')
set(gca,'xtick',[])
set(gca,'xticklabel',[])
xlim([0,length(behavFields) + 1])
...
% Gamma-band-derived mean R2 values
subplot(2,2,4);
scatter(xInds*1,data.muaPower.Contra.Comb.meanR2,100,'MarkerEdgeColor','k','MarkerFaceColor',colorE,'jitter','on','jitterAmount',0.25)
hold on
e1 = errorbar(1,data.muaPower.Contra.avgMeanR2,data.muaPower.Contra.stdMeanR2,'d','MarkerEdgeColor','k','MarkerFaceColor','k');
e1.Color = 'black';
e1.MarkerSize = 15;
e1.CapSize = 15;
scatter(xInds*2,data.muaPower.Whisk.Comb.meanR2,100,'MarkerEdgeColor','k','MarkerFaceColor',colorD,'jitter','on','jitterAmount',0.25)
e2 = errorbar(2,data.muaPower.Whisk.avgMeanR2,data.muaPower.Whisk.stdMeanR2,'d','MarkerEdgeColor','k','MarkerFaceColor','k');
e2.Color = 'black';
e2.MarkerSize = 15;
e2.CapSize = 15;
scatter(xInds*3,data.muaPower.Rest.Comb.meanR2,100,'MarkerEdgeColor','k','MarkerFaceColor',colorA,'jitter','on','jitterAmount',0.25)
e3 = errorbar(3,data.muaPower.Rest.avgMeanR2,data.muaPower.Rest.stdMeanR2,'d','MarkerEdgeColor','k','MarkerFaceColor','k');
e3.Color = 'black';
e3.MarkerSize = 15;
e3.CapSize = 15;
scatter(xInds*4,data.muaPower.NREM.Comb.meanR2,100,'MarkerEdgeColor','k','MarkerFaceColor',colorB,'jitter','on','jitterAmount',0.25)
e4 = errorbar(4,data.muaPower.NREM.avgMeanR2,data.muaPower.NREM.stdMeanR2,'d','MarkerEdgeColor','k','MarkerFaceColor','k');
e4.Color = 'black';
e4.MarkerSize = 15;
e4.CapSize = 15;
scatter(xInds*5,data.muaPower.REM.Comb.meanR2,100,'MarkerEdgeColor','k','MarkerFaceColor',colorC,'jitter','on','jitterAmount',0.25)
e5 = errorbar(5,data.muaPower.REM.avgMeanR2,data.muaPower.REM.stdMeanR2,'d','MarkerEdgeColor','k','MarkerFaceColor','k');
e5.Color = 'black';
e5.MarkerSize = 15;
e5.CapSize = 15;
title({'MUA [300-3000 Hz] derived';'Mean R^2 gamma function kernel predictions'})
ylabel('R^2')
set(gca,'xtick',[])
set(gca,'xticklabel',[])
xlim([0,length(behavFields) + 1])
...
savefig(gammaSummaryFigure,[dirpath 'Summary Figure - GammaBand Kernel Predictions']);
savefig(muaSummaryFigure,[dirpath 'Summary Figure - MUA Kernel Predictions']);
