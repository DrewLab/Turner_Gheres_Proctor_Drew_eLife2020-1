function [] = FigurePanelSix_Manuscript2020(rootFolder,AnalysisResults)
...
sgtitle('Figure panel 6 - Turner Manuscript 2020')
...
savefig(summaryFigure,[dirpath 'Figure Panel 6']);
set(summaryFigure,'PaperPositionMode','auto');
print('-painters','-dpdf','-bestfit',[dirpath 'Figure Panel 6'])
%% statistical diary
diaryFile = [dirpath 'FigurePanel6_Statistics.txt'];
