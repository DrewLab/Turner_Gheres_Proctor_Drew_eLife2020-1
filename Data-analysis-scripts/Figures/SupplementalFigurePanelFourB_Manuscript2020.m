function [] = SupplementalFigurePanelFourB_Manuscript2020(rootFolder,AnalysisResults)
...
sgtitle({'Supplemental Figure Panel 4 - Turner Manuscript 2020','NREM stimulations'})
...
savefig(summaryFigure,[dirpath 'Supplemental Figure Panel 4b']);
set(summaryFigure,'PaperPositionMode','auto');
print('-painters','-dpdf','-fillpage',[dirpath 'Supplemental Figure Panel 4b'])
