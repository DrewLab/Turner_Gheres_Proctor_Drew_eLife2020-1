function [] = FigS14_Manuscript2020(rootFolder)
...
%________________________________________________________________________________________________________________________
%
% Purpose: Generate figure panel S14 for Turner_Kederasetti_Gheres_Proctorostanzo_Drew_Manuscript2020
%________________________________________________________________________________________________________________________

%% Set-up and process data for Fig S14 (a-e)
...
cd(rootFolder)
%% Figure panel S14
summaryFigure = figure('Name','FigS14 (a-e)');
...
savefig(summaryFigure,[dirpath 'FigS14']);
...
print('-painters','-dpdf','-fillpage',[dirpath 'FigS14'])
close(summaryFigure)
%% subplot figures
...
axis off
xlim([0,600])
print('-painters','-dtiffn',[dirpath 'FigS14 subplot images'])
