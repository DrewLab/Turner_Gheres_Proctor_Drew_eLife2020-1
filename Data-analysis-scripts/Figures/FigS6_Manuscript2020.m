function [AnalysisResults] = FigS6_Manuscript2020(rootFolder,saveFigs,delim,AnalysisResults)
...
%________________________________________________________________________________________________________________________
%
% Purpose: Generate figure panel S6 for Turner_Kederasetti_Gheres_Proctorostanzo_Drew_Manuscript2020
%________________________________________________________________________________________________________________________
...
%% Fig. S6
summaryFigure = figure('Name','FigS6 (a-f)'); %#ok<*NASGU>
sgtitle('Supplemental Figure S6 - Turner et al. 2020')
...
if strcmp(saveFigs,'y') == true
    ...
    savefig(summaryFigure,[dirpath 'FigS6']);
    ...
    print('-painters','-dpdf','-bestfit',[dirpath 'FigS6'])
    close(summaryFigure)
    %% subplot figures
    ...
    axis off
    xlim([0,600])
    print('-painters','-dtiffn',[dirpath 'FigS6_SpecImages'])
