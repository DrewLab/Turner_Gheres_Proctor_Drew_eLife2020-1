function [AnalysisResults] = FigS7_Manuscript2020(rootFolder,AnalysisResults)
...
%________________________________________________________________________________________________________________________
%
% Purpose: Generate figure panel S7 for Turner_Kederasetti_Gheres_Proctor_Costanzorew_Manuscript2020
%________________________________________________________________________________________________________________________
...
x1 = xline(35,'color',colorRest,'LineWidth',2);
x2 = xline(175,'color',colorNREM,'LineWidth',2);
x3 = xline(445,'color',colorREM,'LineWidth',2);
xline(610,'color',colorRest,'LineWidth',2);
ylabel('\DeltaHbT')
...
%     mkdir(dirpath);
% end
% savefig(summaryFigure,[dirpath 'FigS7']);
...
% print('-painters','-dpdf','-bestfit',[dirpath 'FigS7'])
% close(summaryFigure)
% %% subplot figures
...
% axis off
% xlim([35,635]) 
% print('-painters','-dtiffn',[dirpath 'FigS7 subplot images'])
...
% hold on
% p5 = plot((1:length(filtLH_HbT))/ProcData.notes.CBVCamSamplingRate,filtLH_HbT,'color',colors_Manuscript2020('dark candy apple red'),'LineWidth',1);
% x1 = xline(35,'color',colorA,'LineWidth',2);
% x2 = xline(175,'color',colorB,'LineWidth',2);
% x3 = xline(445,'color',colorC,'LineWidth',2);
