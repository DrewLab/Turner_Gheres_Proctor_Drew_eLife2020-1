function [AnalysisResults] = FigS7_Manuscript2020(rootFolder,saveFigs,delim,AnalysisResults)
...
%________________________________________________________________________________________________________________________
%
% Purpose: Generate figure panel S7 for Turner_Gheres_Proctor_Drew_Manuscript2020
%________________________________________________________________________________________________________________________
...
sgtitle('Figure S7 - Turner et al. 2020')
...
if strcmp(saveFigs,'y') == true
    ...
    axis off
    xlim([35,635])
    print('-painters','-dtiffn',[dirpath 'FigS7_SpecImages'])
