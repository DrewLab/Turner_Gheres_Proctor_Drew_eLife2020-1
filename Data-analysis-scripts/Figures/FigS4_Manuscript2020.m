function [] = FigS4_Manuscript2020(rootFolder,AnalysisResults)
...
cm.Title = {'Supplemental Figure Panel 4 - Turner Manuscript 2020','','[A] Random forest unseen data confusion matrix',['total accuracy: ' num2str(modelAccuracy) ' (%)']};
% save location
dirpath = [rootFolder '\Summary Figures and Structures\'];
if ~exist(dirpath, 'dir')
    mkdir(dirpath);
end
savefig(confMat,[dirpath 'Supplemental Figure Panel 4 A']);
set(confMat,'PaperPositionMode','auto');
print('-painters','-dpdf','-bestfit',[dirpath 'Supplemental Figure Panel 4 A'])
...
uicontrol('Style','text','Position',[20,100,200,20],'String',{'Supplemental Figure Panel 4 (Continued)','to be made in word at a later point'});
savefig(oobTable,[dirpath 'Supplemental Figure Panel 4 B']);
set(oobTable,'PaperPositionMode','auto');
print('-painters','-dpdf','-fillpage',[dirpath 'Supplemental Figure Panel 4 B'])
