...
%% Fig. S21
summaryFigure = figure('Name','FigS21 (a-o)'); %#ok<*NASGU>
sgtitle('Figure Panel S21 (a-o) Turner Manuscript 2020')
...
ylabel('Coherence')
xlabel('Freq (Hz)')
title({'[S21a] Neural-hemo coherence','delta-HbT',''})
...
e6.MarkerSize = 10;
e6.CapSize = 10;
title({'[S21b] Coherence @ 0.1 Hz','delta-HbT',''})
...
%% [S21c] ultra low delta Coherence
ax3 = subplot(5,3,3);
...
e3.MarkerSize = 10;
e3.CapSize = 10;
title({'[S21c] Coherence @ 0.01 Hz','delta-HbT',''})
...
ylabel('Coherence')
xlabel('Freq (Hz)')
title({'[S21d] Neural-hemo coherence','theta-HbT',''})
axis square
xlim([0.003,0.5])
ylim([0,1])
set(gca,'box','off')
ax4.TickLength = [0.03,0.03];
%% [S21e] theta Coherence
ax5 = subplot(5,3,5);
...
e6.MarkerSize = 10;
e6.CapSize = 10;
title({'[S21e] Coherence @ 0.1 Hz','theta-HbT',''})
ylabel('Coherence @ 0.1 Hz')
set(gca,'xtick',[])
set(gca,'xticklabel',[])
axis square
...
%% [S21f] ultra low theta Coherence
ax6 = subplot(5,3,6);
...
e3.MarkerSize = 10;
e3.CapSize = 10;
title({'[S21f] Coherence @ 0.01 Hz','theta-HbT',''})
ylabel('Coherence 0.01 Hz')
set(gca,'xtick',[])
set(gca,'xticklabel',[])
axis square
...
ylabel('Coherence')
xlabel('Freq (Hz)')
title({'[S21g] Neural-hemo coherence','alpha-HbT',''})
axis square
xlim([0.003,0.5])
ylim([0,1])
set(gca,'box','off')
ax7.TickLength = [0.03,0.03];
%% [S21h] alpha Coherence
ax8 = subplot(5,3,8);
...
e6.MarkerSize = 10;
e6.CapSize = 10;
title({'[S21h] Coherence @ 0.1 Hz','alpha-HbT',''})
ylabel('Coherence @ 0.1 Hz')
set(gca,'xtick',[])
set(gca,'xticklabel',[])
axis square
...
%% [S21i] ultra low alpha Coherence
ax9 = subplot(5,3,9);
...
e3.MarkerSize = 10;
e3.CapSize = 10;
title({'[S21i] Coherence @ 0.01 Hz','alpha-HbT',''})
ylabel('Coherence 0.01 Hz')
set(gca,'xtick',[])
set(gca,'xticklabel',[])
axis square
...
ylabel('Coherence')
xlabel('Freq (Hz)')
title({'[S21j] Neural-hemo coherence','beta-HbT',''})
axis square
xlim([0.003,0.5])
ylim([0,1])
set(gca,'box','off')
...
e6.MarkerSize = 10;
e6.CapSize = 10;
title({'[S21k] Coherence @ 0.1 Hz','beta-HbT',''})
ylabel('Coherence @ 0.1 Hz')
set(gca,'xtick',[])
set(gca,'xticklabel',[])
axis square
...
e3.MarkerSize = 10;
e3.CapSize = 10;
title({'[S21l] Coherence @ 0.01 Hz','beta-HbT',''})
ylabel('Coherence 0.01 Hz')
set(gca,'xtick',[])
set(gca,'xticklabel',[])
axis square
...
ylabel('Coherence')
xlabel('Freq (Hz)')
title({'[S21m] Neural-hemo coherence','gamma-HbT',''})
axis square
xlim([0.003,0.5])
ylim([0,1])
set(gca,'box','off')
ax13.TickLength = [0.03,0.03];
%% [S21n] gamma Coherence
ax14 = subplot(5,3,14);
...
e6.MarkerSize = 10;
e6.CapSize = 10;
title({'[S21n] Coherence @ 0.1 Hz','gamma-HbT',''})
ylabel('Coherence @ 0.1 Hz')
set(gca,'xtick',[])
set(gca,'xticklabel',[])
axis square
...
%% [S21o] ultra low gamma Coherence
ax15 = subplot(5,3,15);
...
e3.MarkerSize = 10;
e3.CapSize = 10;
title({'[S21o] Coherence @ 0.01 Hz','gamma-HbT',''})
ylabel('Coherence 0.01 Hz')
set(gca,'xtick',[])
set(gca,'xticklabel',[])
axis square
