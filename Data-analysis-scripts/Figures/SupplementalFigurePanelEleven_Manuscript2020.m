function [] = SupplementalFigurePanelEleven_Manuscript2020(rootFolder,AnalysisResults)
...
sgtitle('Supplemental Figure Panel 11 - Turner Manuscript 2020')
%% [A] Short whisks
ax1 = subplot(1,3,1);
...
savefig(summaryFigure,[dirpath 'Supplemental Figure Panel 11']);
set(summaryFigure,'PaperPositionMode','auto');
print('-painters','-dpdf','-fillpage',[dirpath 'Supplemental Figure Panel 11'])
