function [decData,decFileIDs,decVesselIDs,decDurations,decEventTimes] = RemoveInvalidData_2P_Manuscript2020(data,fileIDs,vesselIDs,durations,eventTimes,ManualDecisions)
...
for a = 1:size(data,1)
    ...
    for b = 1:length(ManualDecisions.fileIDs)
        [~,~,~,manualFileID,~,~] = GetFileInfo2_2P_Manuscript2020(ManualDecisions.fileIDs{b,1});
