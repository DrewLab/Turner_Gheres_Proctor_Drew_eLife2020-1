...
%             allStimDurations = zeros(length(allStimEventTimes),1);
%             % decimate the file list to only include those files that occur within the desired number of target minutes
%             [finalStimHbTData,finalStimFileIDs,~,finalStimFileEventTimes] = KeepSleepData_IOS_Manuscript2020(allStimHbTData,allStimFileIDs,allStimDurations,allStimEventTimes,ScoringResults,'NREM Sleep');
%             [finalStimCBVData,~,~,~] = KeepSleepData_IOS_Manuscript2020(allStimCBVData,allStimFileIDs,allStimDurations,allStimEventTimes,ScoringResults,'NREM Sleep');
%             [finalStimCortMUAData,~,~,~] = KeepSleepData_IOS_Manuscript2020(allStimCortMUAData,allStimFileIDs,allStimDurations,allStimEventTimes,ScoringResults,'NREM Sleep');
%             [finalStimHipMUAData,~,~,~] = KeepSleepData_IOS_Manuscript2020(allStimHipMUAData,allStimFileIDs,allStimDurations,allStimEventTimes,ScoringResults,'NREM Sleep');
%             % lowpass filter each whisking event and mean-subtract by the first 2 seconds
...
%             allStimDurations = zeros(length(allStimEventTimes),1);
%             % decimate the file list to only include those files that occur within the desired number of target minutes
%             [finalStimHbTData,finalStimFileIDs,~,finalStimFileEventTimes] = KeepSleepData_IOS_Manuscript2020(allStimHbTData,allStimFileIDs,allStimDurations,allStimEventTimes,ScoringResults,'REM Sleep');
%             [finalStimCBVData,~,~,~] = KeepSleepData_IOS_Manuscript2020(allStimCBVData,allStimFileIDs,allStimDurations,allStimEventTimes,ScoringResults,'REM Sleep');
%             [finalStimCortMUAData,~,~,~] = KeepSleepData_IOS_Manuscript2020(allStimCortMUAData,allStimFileIDs,allStimDurations,allStimEventTimes,ScoringResults,'REM Sleep');
%             [finalStimHipMUAData,~,~,~] = KeepSleepData_IOS_Manuscript2020(allStimHipMUAData,allStimFileIDs,allStimDurations,allStimEventTimes,ScoringResults,'REM Sleep');
%             % lowpass filter each whisking event and mean-subtract by the first 2 seconds
%             clear procStimHbTData procStimCBVData procStimCorticalMUAData procStimHippocampalMUAData finalStimStartTimes finalStimEndTimes finalStimFiles
%             if ~isempty(finalStimCBVData) == true
%                 ii = 1;
